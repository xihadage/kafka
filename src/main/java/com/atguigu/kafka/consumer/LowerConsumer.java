...
public class LowerConsumer {
    public static void main(String[] args){
        ...
        lowerConsumer.findLeader(brokers,port,topic,partition);
    }
    //找分区leader
    ...
    //获取数据
    private void getDate(List<String> brokers, int port, String topic, int partition,long offset){
        //获取分区leader
